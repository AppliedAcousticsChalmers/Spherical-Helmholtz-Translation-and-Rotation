"""Small helper module to manage indexing of arrays.

This defines classes to convert between linear index and the multiple indices of coefficients.
The implementations here also serve as the statement of the conventions for this package.
"""
